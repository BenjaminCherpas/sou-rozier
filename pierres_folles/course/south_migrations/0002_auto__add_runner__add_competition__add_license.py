...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Runner'
        db.create_table(u'course_runner', (
            (u'contact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Crm.Contact'], unique=True, primary_key=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Competition'])),
            ('club', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('license', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['course.License'], null=True, blank=True)),
            ('license_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal(u'course', ['Runner'])

        # Adding model 'Competition'
        db.create_table(u'course_competition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'course', ['Competition'])

        # Adding model 'License'
        db.create_table(u'course_license', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'course', ['License'])


    def backwards(self, orm):
        # Deleting model 'Runner'
        db.delete_table(u'course_runner')

        # Deleting model 'Competition'
        db.delete_table(u'course_competition')

        # Deleting model 'License'
        db.delete_table(u'course_license')
