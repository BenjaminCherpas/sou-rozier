...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'License.nb_required'
        db.add_column(u'course_license', 'nb_required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'License.name'
        db.alter_column(u'course_license', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'License.nb_required'
        db.delete_column(u'course_license', 'nb_required')


        # Changing field 'License.name'
        db.alter_column(u'course_license', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
