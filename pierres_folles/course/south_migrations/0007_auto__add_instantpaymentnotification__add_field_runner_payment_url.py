...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstantPaymentNotification'
        db.create_table(u'course_instantpaymentnotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('runner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.Runner'])),
            ...
            ('is_ssl_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_amount_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_email_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_contact_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('transaction_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'course', ['InstantPaymentNotification'])

        # Adding field 'Runner.payment_url'
        db.add_column(u'course_runner', 'payment_url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstantPaymentNotification'
        db.delete_table(u'course_instantpaymentnotification')

        # Deleting field 'Runner.payment_url'
        db.delete_column(u'course_runner', 'payment_url')
