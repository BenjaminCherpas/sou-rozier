...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstantPaymentNotification.signature_ok'
        db.add_column(u'course_instantpaymentnotification', 'signature_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstantPaymentNotification.signature_ok'
        db.delete_column(u'course_instantpaymentnotification', 'signature_ok')
