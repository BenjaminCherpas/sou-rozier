...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'course_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('year1', self.gf('django.db.models.fields.IntegerField')()),
            ('year2', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'course', ['Category'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'course_category')
