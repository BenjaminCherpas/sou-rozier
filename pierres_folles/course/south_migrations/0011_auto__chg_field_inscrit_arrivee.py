...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inscrit.arrivee'
        db.alter_column(u'course_inscrit', 'arrivee', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Inscrit.arrivee'
        db.alter_column(u'course_inscrit', 'arrivee', self.gf('django.db.models.fields.DateTimeField')(null=True))
