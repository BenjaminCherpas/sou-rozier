...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inscrit.city'
        db.add_column(u'course_inscrit', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Inscrit.zip_code'
        db.add_column(u'course_inscrit', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Inscrit.email'
        db.add_column(u'course_inscrit', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inscrit.city'
        db.delete_column(u'course_inscrit', 'city')

        # Deleting field 'Inscrit.zip_code'
        db.delete_column(u'course_inscrit', 'zip_code')

        # Deleting field 'Inscrit.email'
        db.delete_column(u'course_inscrit', 'email')
    ...
    models = {
        ...
        u'course.inscrit': {
            'Meta': {'ordering': "('numero', 'nom', 'prenom', 'arrivee')", 'object_name': 'Inscrit'},
            'arrivee': ('django.db.models.fields.TimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'zip_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'})
        },
