...
EMAIL_PORT = 25
EMAIL_SUBJECT_PREFIX = 'sou-rozier '
EMAIL_HOST_PASSWORD = 'Pres-de-ses-sous'
EMAIL_HOST_USER = 'contact@sou-rozier.fr'
SECRET_KEY = '8!-1hjkhk@6tGhgejjhvs6GnJnge7$Op9.=+/lE'

DEFAULT_FROM_EMAIL = u'"Sou des écoles de Rozier en Donzy" <contact@sou-rozier.fr>'
