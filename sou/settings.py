...
MIDDLEWARE = (
    ...
    'coop_cms.middleware.PermissionsMiddleware',
    "coop_cms.utils.RequestMiddleware",
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'sou.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sou.wsgi.application'
...
BALAFON_MY_COMPANY = "Sou des écoles de Rozier en Donzy"
BALAFON_AS_HOMEPAGE = False
BALAFON_NOTIFICATION_EMAIL = 'luc.jean@gmail.com'
BALAFON_NO_ENTITY_TYPE = True
BALAFON_REGISTRATION_ACCEPT_USE_OF_TERMS_LINK = '/conditions-dutilisation'
BALAFON_SUBSCRIBE_FORM = "balafon.Emailing.forms.MinimalSubscribeForm"
BALAFON_EMAIL_SUBSCRIBE_ENABLED = False
...
COOP_CMS_ARTICLE_LOGO_SIZE = "300"
COOP_CMS_NEWSLETTER_TEMPLATES = (
    ('newsletters/basic_newsletter.html', u'Newsletter'),
)
COOP_CMS_ARTICLE_TEMPLATES = (
    ('standard_nologo.html', u'Sans logo'),
    ('standard.html', u'Avec logo'),
    ('standard_docs.html', u'Standard avec docs'),
    ('standard_and_info.html', u'Standard avec info'),
)
COOP_CMS_FROM_EMAIL = u'"Sou des écoles de Rozier en Donzy" <contact@sou-rozier.fr>'
COOP_CMS_TEST_EMAILS = ('"Luc JEAN" <luc.jean@gmail.com>',)
COOP_CMS_SITE_PREFIX = ''
COOP_CMS_REPLY_TO = 'contact@sou-rozier.fr'
COOP_CMS_TITLE_OPTIONAL = True
THUMBNAIL_FORMAT = 'PNG'
LOGIN_REDIRECT_URL = "/"


AUTH_PROFILE_MODULE = 'Profile.ContactProfile'
ACCOUNT_ACTIVATION_DAYS = 7

BALAFON_REGISTRATION_FORM = 'sou.forms.ParentRegistrationForm'
