	...
	$.fn.galleriffic = function(settings) {
		...
		$.extend(this, {
			...
			buildPager: function(pager) {
				...
				if (page > 0) {
					var prevPage = startIndex - this.numThumbs;
					pager.append('<a rel="history" href="#'+this.data[prevPage].hash+'" title="'+this.prevPageLinkTitle+'">'+this.prevPageLinkText+'</a>');
				}
				...
				if (nextPage < this.data.length) {
					pager.append('<a rel="history" href="#'+this.data[nextPage].hash+'" title="'+this.nextPageLinkTitle+'">'+this.nextPageLinkText+'</a>');
				}
